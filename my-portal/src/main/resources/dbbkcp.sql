...
-- Started on 2018-09-05 07:05:38
...
--
-- TOC entry 2919 (class 0 OID 16588)
-- Dependencies: 207
...
--
-- TOC entry 2928 (class 0 OID 16762)
-- Dependencies: 216
...
20	1	60.00	4	10.00	10to30	10.00
...
-24	2	89.00	1	5.00	3to10	30.00
\.


--
-- TOC entry 2915 (class 0 OID 16540)
-- Dependencies: 203
...
--
-- TOC entry 2924 (class 0 OID 16676)
-- Dependencies: 212
...
--
-- TOC entry 2922 (class 0 OID 16669)
-- Dependencies: 210
...
--
-- TOC entry 2925 (class 0 OID 16738)
-- Dependencies: 213
...
--
-- TOC entry 2917 (class 0 OID 16569)
-- Dependencies: 205
-- Data for Name: medicine_master; Type: TABLE DATA; Schema: eps; Owner: postgres
--

COPY eps.medicine_master (medicine_name, disease_code, disease_name, clinical_availability, age_group, treatment_id, dosage) FROM stdin;
\.


--
-- TOC entry 2930 (class 0 OID 16777)
-- Dependencies: 218
...
--
-- TOC entry 2921 (class 0 OID 16654)
-- Dependencies: 209
-- Data for Name: patients; Type: TABLE DATA; Schema: eps; Owner: postgres
--

COPY eps.patients (p_id, first_name, last_name, dob_dd, dob_mm, dob_yy, contact_no1, contact_no2, discount, ts_created, blood_group, weight, image) FROM stdin;
1	sourabh	sadhu	27	3	1992	9046787913	7980231838	20	2018-08-19 21:41:38.485861	B+	80	\N
\.


--
-- TOC entry 2916 (class 0 OID 16560)
-- Dependencies: 204
...
--
-- TOC entry 2913 (class 0 OID 16509)
-- Dependencies: 201
...
--
-- TOC entry 2920 (class 0 OID 16634)
-- Dependencies: 208
...
SELECT pg_catalog.setval('eps.medical_history_id_seq', 9, true);
...
SELECT pg_catalog.setval('eps.patient_id_seq', 1, true);
...
SELECT pg_catalog.setval('eps.prescription_id_seq', 15, true);
...
--
-- TOC entry 2761 (class 2606 OID 16641)
...
--
-- TOC entry 2773 (class 2606 OID 16766)
...
--
-- TOC entry 2753 (class 2606 OID 16545)
...
--
-- TOC entry 2767 (class 2606 OID 16673)
...
--
-- TOC entry 2769 (class 2606 OID 16684)
...
--
-- TOC entry 2771 (class 2606 OID 16759)
...
--
-- TOC entry 2757 (class 2606 OID 16795)
...
--
-- TOC entry 2775 (class 2606 OID 16782)
...
--
-- TOC entry 2755 (class 2606 OID 16568)
...
--
-- TOC entry 2765 (class 2606 OID 16663)
...
--
-- TOC entry 2751 (class 2606 OID 16513)
...
--
-- TOC entry 2763 (class 2606 OID 16648)
...
--
-- TOC entry 2782 (class 2606 OID 16642)
...
--
-- TOC entry 2778 (class 2606 OID 16705)
-- Name: fees_breakup clinical_findings_f_key; Type: FK CONSTRAINT; Schema: eps; Owner: postgres
--

ALTER TABLE ONLY eps.fees_breakup
    ADD CONSTRAINT clinical_findings_f_key FOREIGN KEY (clinical_findings_ref) REFERENCES eps.clinical_findings(f_id);


--
-- TOC entry 2784 (class 2606 OID 16690)
-- Name: medical_history medical_history_name_f_key; Type: FK CONSTRAINT; Schema: eps; Owner: postgres
--

ALTER TABLE ONLY eps.medical_history
    ADD CONSTRAINT medical_history_name_f_key FOREIGN KEY (medical_history_name) REFERENCES eps.medical_history_master(medical_history_name);


--
-- TOC entry 2786 (class 2606 OID 16741)
...
--
-- TOC entry 2781 (class 2606 OID 16649)
...
--
-- TOC entry 2780 (class 2606 OID 16581)
...
--
-- TOC entry 2787 (class 2606 OID 16746)
...
--
-- TOC entry 2783 (class 2606 OID 16685)
-- Name: medical_history patient_id_f_key; Type: FK CONSTRAINT; Schema: eps; Owner: postgres
--
...
--
-- TOC entry 2777 (class 2606 OID 16700)
...
--
-- TOC entry 2779 (class 2606 OID 16664)
...
--
-- TOC entry 2785 (class 2606 OID 16786)
-- Name: medical_history prescription_hist_f_key; Type: FK CONSTRAINT; Schema: eps; Owner: postgres
--

ALTER TABLE ONLY eps.medical_history
    ADD CONSTRAINT prescription_hist_f_key FOREIGN KEY (prescription_id) REFERENCES eps.prescription_history(prescription_id);


--
-- TOC entry 2776 (class 2606 OID 16695)
...
-- Completed on 2018-09-05 07:05:41
