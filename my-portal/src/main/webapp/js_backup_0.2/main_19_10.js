...
/*!**********************************!*\
  !*** ./src/app/models/models.ts ***!
  \**********************************/
/*! exports provided: Response, ClinicalFindingView, MedicalMaster, Patient, PrescriptionHistoryView, ToothQuadrentView, TreatmentPlan, MedicineView, FeesBreakupView, MedicalHistoryView, MedicineHistoryView, DashboardView */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var HttpcommService = /** @class */ (function () {
    function HttpcommService(http) {
        ...
        this.getFeeConfigAgeGrpPart1Url = '?age_grp=';
    ...
    HttpcommService.prototype.getFeeConfig = function (ageGrp, toothGrpIndex, trtmntId) {
        if (this.dummy) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.parseData(this.dummyResp.getFeeConfig));
        }
        else {
            var url = this.getFeeConfig + this.getFeeConfigAgeGrpPart1Url + ageGrp + this.getFeeConfigToothGrpPart2Url + toothGrpIndex + this.getFeeConfigTrtIdPart3Url + trtmntId;
            return this.genericGetRequest(url);
        }
    };
