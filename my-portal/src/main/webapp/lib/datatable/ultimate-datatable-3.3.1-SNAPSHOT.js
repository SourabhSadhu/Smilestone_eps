...
.run(['$templateCache', function($templateCache) {
  $templateCache.put('udt-table.html',
   ...
   +        '</div>'*/
   +        '<div class="inProgress" ng-if="udtTable.config.spinner.start">'
   +            '<img src="../img/indepay_loader.gif" width="64" />'
   +        '</div>'
...
.run(['$templateCache', function($templateCache) {
  $templateCache.put('udt-toolbar.html',
   ...
   +        '</div>'
   +        '<div class="col-xs-2 .col-sm-3 col-md-3 col-lg-6" name="udt-toolbar-filter" ng-if="udtTable.config.filter.active === true" style="padding-left:0" >'
