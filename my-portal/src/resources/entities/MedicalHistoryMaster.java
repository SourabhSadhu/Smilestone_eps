...
public class MedicalHistoryMaster implements Serializable {
	...
	@Id
//	@SequenceGenerator(name="MEDICAL_HISTORY_MASTER_MEDICALHISTORYNAME_GENERATOR", sequenceName="REPLACE_SEQ_NAME")
//	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="MEDICAL_HISTORY_MASTER_MEDICALHISTORYNAME_GENERATOR")
