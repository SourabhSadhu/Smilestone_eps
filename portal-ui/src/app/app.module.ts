...
import { PrintComponent,DoctorSelectionDialog } from './print/print.component';
...
@NgModule({
  ...
  entryComponents: [SnackhelperComponent,DialogToothClinicalfindings,CustomFeeInsertionDialog,DoctorSelectionDialog]
})
